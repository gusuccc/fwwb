...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    // who's width is unknown util an edge has been hit. `seriesBackwardPressure` is the number of
...
// Figure out which path forward (via seg.forwardSegs) results in the longest path util
