...
(function (global, factory) {
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        // Incrementing the current day util it is no longer a hidden day, returning a copy.
        ...
        View.prototype.startNowIndicator = function (dateProfile) {
            ...
            if (this.opt('nowIndicator')) {
                ...
                if (unit) {
                    ...
                    // wait util the beginning of the next interval
                    delay = dateEnv.add(dateEnv.startOf(this.initialNowDate, unit), createDuration(1, unit)).valueOf() - this.initialNowDate.valueOf();
                    // TODO: maybe always use setTimeout, waiting util start of next unit
    ...
    */
    ...
    var DayTable = /** @class */ (function () {
        function DayTable(daySeries, breakOnWeeks) {
            ...
            var rowCnt;
            if (breakOnWeeks) {
                // count columns util the day-of-week repeats
