    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.isInteracting = false; // is the user validly moving the pointer? lasts util pointerup
            _this.isDragging = false; // is it INTENTFULLY dragging? lasts util after revert animation
